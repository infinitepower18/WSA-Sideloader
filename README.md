...
You can also install from [GitHub Releases](https://github.com/infinitepower18/WSA-Sideloader/releases) or via winget `winget install infinitepower18.WSASideloader`
